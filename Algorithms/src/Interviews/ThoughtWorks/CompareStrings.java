 ...
 *
 * Input Constraints , * Sample Input 5 5 11111 00010 1 2 3 4 5 Sample Output NO
 * NO NO NO YES Explanation After 1st query: B = 10010. B < A. (NO) After 2nd
 * query: B = 11010. B < A. (NO) After 3rd query: B = 11110. B < A. (NO) After
 * 4th query: B = 11110. B < A. (NO) After 5th query: B = 11111. B = A. (YES)
 */
