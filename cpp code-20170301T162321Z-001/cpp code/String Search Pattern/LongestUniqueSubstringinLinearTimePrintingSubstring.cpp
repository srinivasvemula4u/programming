...
int UniqueSubString(string str)
{
    ...
    int Prev_Index;
    int Begin_index =0, End_Index =0, Max_BeginIndex=0, Max_EndIndex=0;
    ...
    {   End_Index = index;
        ...
        cout <<" Index = " << index <<" Begin_Index = "<< Begin_index << "  End_Index = " <<End_Index <<endl;
        cout << " Max_Begin Index =  "<< Max_BeginIndex << " Max_EndIndex = " << Max_EndIndex <<endl <<endl;
        ...
        else
        {
            if( Max_SubStringLen < Current_SubStringLen) {
                    Max_SubStringLen = Current_SubStringLen;
                     Max_BeginIndex = Begin_index;
                     Max_EndIndex = End_Index;
                     cout << " After Modified  Max_Begin Index =  "<< Max_BeginIndex << " Max_EndIndex = " << Max_EndIndex <<endl <<endl;
                      string substring(str.begin()+Max_BeginIndex,str.begin()+Max_EndIndex);
                        cout << " Longest Substring with Unique characters = "<<substring <<endl <<endl;
            }
    ...
    cout <<"Last Index = " << index <<" Begin_Index = "<< Begin_index << "  End_Index = " <<End_Index <<endl;
        cout << " Last Max_Begin Index =  "<< Max_BeginIndex << " Max_EndIndex = " << Max_EndIndex <<endl <<endl;
    string substring(str.begin()+Max_BeginIndex,str.begin()+Max_EndIndex);
    cout << " Longest Substring with Unique characters = "<<substring <<endl;
    return Max_SubStringLen;
}

int main()
{
    cout << " Maximum Length of Unique Substring = "<<UniqueSubString("ABDAEFGGHABEF") <<endl;
}
