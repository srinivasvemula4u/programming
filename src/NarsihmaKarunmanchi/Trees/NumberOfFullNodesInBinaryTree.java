...
public class NumberOfFullNodesInBinaryTree {
    public static int numberOfFullNodesInBinaryTree(BinaryTreeNode root)
    {
    ...
    public static void main(String args[]) {
        ...
        tree.insert(14);
          tree.insert(15);
        System.out.println("Number of LeafNodes in a tree is " + numberOfFullNodesInBinaryTree(tree.getRoot()));
